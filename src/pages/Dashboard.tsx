...
import { TrendingUp, Zap, PieChart, Activity } from 'lucide-react';
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">24h successful swaps</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">AI routing enabled</p>
          </CardContent>
        </Card>
      </div>
